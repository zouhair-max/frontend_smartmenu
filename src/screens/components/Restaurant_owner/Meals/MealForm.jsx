            ...
            <form onSubmit={handleSubmit} className="p-8">
                ...
                <div className="space-y-6">
                  <div className="bg-gradient-to-r from-yellow-50 to-amber-50 p-6 rounded-xl border border-yellow-100">
                    ...
                    <div className="mb-6">
                      ...
                      <select
                        required
                        className="w-full p-4 border-2 border-gray-200 rounded-xl focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 transition-all duration-200 bg-white shadow-sm"
                    ...
                    <div className="mb-6">
                      ...
                      <div className="relative">
                        <input
                          ...
                          min="0"
                          required
                          className="w-full p-4 pl-12 border-2 border-gray-200 rounded-xl focus:border-amber-500 focus:ring-2 focus:ring-amber-200 transition-all duration-200 bg-white shadow-sm"
                    ...
                    <div className="mb-6">
                      ...
                      <input
                        type="number"
                        className="w-full p-4 border-2 border-gray-200 rounded-xl focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all duration-200 bg-white shadow-sm"
                  ...
                  <div className="bg-gradient-to-r from-red-50 to-orange-50 p-6 rounded-xl border border-red-100">
                    ...
                    <div className="space-y-4">
                      <label className="block">
                        ...
                        />
                        <div className="border-2 border-dashed border-red-300 rounded-xl p-8 text-center cursor-pointer hover:border-red-400 hover:bg-orange-25 transition-all duration-200 group">
                          <Upload className="w-12 h-12 text-orange-400 mx-auto mb-4 group-hover:text-orange-500" />
                          <p className="text-gray-600 font-medium">Click to upload meal image</p>
                        ...
                        <div className="mt-4">
                          ...
                          <div className="relative inline-block">
                            <img
                              ...
                              alt="Preview"
                              className="w-48 h-48 object-cover rounded-xl shadow-md border-2 border-white"
                            />
                            <div className="absolute inset-0 border-2 border-yellow-200 rounded-xl pointer-events-none"></div>
                          </div>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          type="text"
                          required
                          className="w-full p-4 border-2 border-gray-200 rounded-xl focus:border-red-500 focus:ring-2 focus:ring-red-200 transition-all duration-200 bg-white shadow-sm"
                      ...
                      <div>
                        ...
                        <textarea
                          rows="4"
                          className="w-full p-4 border-2 border-gray-200 rounded-xl focus:border-red-500 focus:ring-2 focus:ring-red-200 transition-all duration-200 bg-white shadow-sm resize-none"
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          type="text"
                          required
                          className="w-full p-4 border-2 border-gray-200 rounded-xl focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all duration-200 bg-white shadow-sm text-right"
                      ...
                      <div>
                        ...
                        <textarea
                          rows="4"
                          className="w-full p-4 border-2 border-gray-200 rounded-xl focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all duration-200 bg-white shadow-sm resize-none text-right"
              ...
              <div className="flex justify-end space-x-4 mt-8 pt-8 border-t border-gray-200">
                <button
                  ...
                  className="px-8 py-3 border-2 border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 font-semibold flex items-center gap-2"
                >
                  <X className="w-5 h-5" />
                  Cancel
                </button>
                <button
                  type="submit"
                  disabled={loading}
                  className="px-8 py-3 bg-gradient-to-r from-yellow-500 to-orange-500 text-white rounded-xl hover:from-yellow-600 hover:to-orange-600 transform hover:scale-105 transition-all duration-200 font-semibold shadow-lg flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                >
